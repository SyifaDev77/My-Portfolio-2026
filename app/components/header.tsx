...
export default function Navbar() {
  ...
  <div className="flex h-20 w-full max-w-5xl items-center justify-between rounded-full border border-[var(--accent)]/20 bg-surface px-6 text-[var(--foreground)] shadow-[0_18px_50px_rgba(15,23,42,0.32)] backdrop-blur transition hover:border-[var(--accent)]/40 hover:shadow-[0_22px_60px_rgba(15,23,42,0.38)] sm:px-8">
